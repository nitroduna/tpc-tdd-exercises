...
${project.name} - ${project.description}
    ...
    Introducción al uso de mocks y/o stubs para programación de
...
* RESUMEN
    ...
    * Cuando usar verificación por estado, y cuando usar verificación
      por interacción. Ventajas e inconvenientes.

    []

    * Decidiendo entre testing con mocks/stubs o tests de
      integración. Cuando. Ventajas e inconvenientes.
